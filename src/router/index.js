...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        component: () => import('@/views/classifiedManage/index'),
  ...
  {
    path: '/friendslinkManage',
    component: Layout,
    children: [
      {
        path: 'index',
        name: 'friendslinkManage',
        component: () => import('@/views/friendslinkManage/index'),
    ...
    children: [
      {
        path: 'index',
        name: 'siteSettings',
        component: () => import('@/views/siteSettings/index'),
        meta: { title: '网站设置', icon: '' }
      }
    ]
  },
